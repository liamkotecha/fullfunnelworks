        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="mt-3 flex items-center justify-between rounded-2xl border border-white/25 bg-white/85 backdrop-blur-xl shadow-[0_2px_24px_rgba(15,31,61,0.07)] px-5 h-14">
            <Link href="/" className="flex items-center shrink-0">
              <Image src="/logo_blue_650.webp" alt="Full Funnel" width={120} height={32} className="h-7 w-auto" priority />
            </Link>
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <Link href="/register?role=consultant" className="text-sm font-bold px-5 py-2 rounded-xl bg-[#0F1F3D] text-white hover:bg-[#0F1F3D]/88 transition-all hover:shadow-lg">Get started</Link>
            </div>
          ...
          <AnimatePresence>
            {menuOpen && (
              ...
              >
                ...
                <Link href="/register?role=consultant" className="text-sm font-bold px-5 py-3 rounded-xl bg-[#0F1F3D] text-white text-center" onClick={() => setMenuOpen(false)}>Get started free</Link>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-8">
              <Image src="/logo_blue_650.webp" alt="Full Funnel" width={100} height={28} className="h-6 w-auto opacity-50" />
