...
export default function ProjectDetailPage() {
  ...
  if (!project) return (
    <div className="max-w-3xl mx-auto text-center py-20">
      ...
      <Button variant="secondary" className="mt-4" onClick={() => router.push("/consultant/projects")}>
        Back to projects
      </Button>
    </div>
  );
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="card space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link
            href={`/consultant/projects/${id}/revenue-execution`}
          ...
          <Link
            href={`/consultant/projects/${id}/execution-planning`}
            className="flex items-center gap-3 rounded-lg border border-slate-200 p-4 hover:border-slate-300 transition-colors group"
          >
